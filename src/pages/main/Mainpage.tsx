    ...
    <div className="min-h-screen bg-[#4D6FFF] text-white px-6 py-8 space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-lg font-semibold">스뮤시그널에 오신 것을 환영합니다!</p>
        </div>
        <div>
          {/* 설정 아이콘 자리 */}
          <button>
      ...
      <div className="bg-[#3C57E8] rounded-2xl p-5 flex justify-between items-center">
        <div>
          ...
          <p className="text-sm opacity-80">당신의 짝을 보고 싶을 때</p>
        </div>
        {/* 하트 이미지 자리 */}
        <img src="/images/hearts.png" alt="하트" className="w-14 h-14" />
      </div>

      {/* 추천 코드 표시 */}
      <div className="bg-[#6741FF] rounded-xl p-4 flex items-center justify-between">
        <div className="text-lg font-semibold">내 추천인 코드</div>
        <div className="text-white text-xl font-bold">KJ232A</div>
        <img src="/icons/copy.svg" alt="복사" className="w-6 h-6" />
      </div>
